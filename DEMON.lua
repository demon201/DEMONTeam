...
if Devmfm:get(mustafa..'mfm:Add:Newton'..msg.chat_id_..'',text) then
...
os.execute('wget https://raw.githubusercontent.com/demon201/DEMONTeam/master/DEMON.lua') 
dofile('DEMON.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/demon201/DEMONTeamFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/demon201/DEMONTeamFiles/master/DEMONTeamFiles/"..FileName)
if Res == 200 then
